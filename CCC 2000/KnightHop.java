...
public class KnightHop {
    private static ArrayList<String> possibleMove(int currentX, int currentY){
    ...
    public static void main(String[] args)
    {
        ...
        boolean startWhile;
        if (startX == Integer.parseInt(end.split(" ")[0]) && startY == Integer.parseInt(end.split(" ")[1])){
            startWhile = false; }
        else { startWhile = true; }

        ArrayList<String> toCheck = new ArrayList<>(possibleMove(startX, startY));
